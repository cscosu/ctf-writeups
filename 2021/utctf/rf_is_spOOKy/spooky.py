...
class spooky(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/CHANGEME/cut.u8', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/CHANGME/cut.u8', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_char_to_float_0, 0), (self.blocks_throttle_0_0, 0))
        ...
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_char_to_float_0, 0))
...
def main(top_block_cls=spooky, options=None):
